...
class Leaderboard(models.Model):
    ...
    medium_issues_solved = models.IntegerField() # Count the number of medium issues solved.
    hard_issues_solved = models.IntegerField() # Count the number of hard issues solved.
    pr_opened = models.IntegerField() # Count the number of PRs opened.
    pr_merged = models.IntegerField() # Count the number of PRs merged.
    '''
